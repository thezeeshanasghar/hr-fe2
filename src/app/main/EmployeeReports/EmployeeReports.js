...
class EmployeeReports extends Component {
	...
	getEmployeeDetail = () => {
		if(this.state.Default == null || this.state.Month ==""){
			return false;
		}
		var obj={
	...
	render() {
		...
		return (
			<FusePageSimple
				...
				header={
					<div className="p-24">
						<h4>Employee Payment Report-{this.state.Default !=null?this.state.Default.Company:"No Company Selected Yet"}</h4></div>
				}
